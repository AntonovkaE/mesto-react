    ...
    return (
        <div className={`popup popup_${props.name} ${props.isOpen && 'popup_open'}   close-area`} visibility="hidden">
            <div className="popup__container">
                <button onClick={props.handleClose}  type="button" className="button popup__button popup__button_type_close close-area" data-bs-dismiss="edit-form" aria-label="Close" data-close>
